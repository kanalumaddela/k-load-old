                ...
                <div class="card-action row">
                 <?php
                    ...
                    <div class="input-field col s12" style="margin-bottom: 15px;">
                        <p>Background Type</p>
                        <p>
                            <input type="radio" id="bg_type_default" class="with-gap" name="background_type" onclick="checkBackgroundType()" value="0" <?php if ($user_bg_type == 0) {
                            echo 'checked="checked"';
                        } ?> />
                            <label for="bg_type_default">Default</label>
                        </p>
                        <p>
                            <input type="radio" id="bg_type_color" class="with-gap" name="background_type" onclick="checkBackgroundType()" value="1" <?php if ($user_bg_type == 1) {
                            echo 'checked="checked"';
                        } ?> />
                            <label for="bg_type_color">Color</label>
                        </p>
                        <p>
                            <input type="radio" id="bg_type_image" class="with-gap" name="background_type" onclick="checkBackgroundType()" value="2" <?php if ($user_bg_type == 2) {
                            echo 'checked="checked"';
                        } ?> />
                            <label for="bg_type_image">Image</label>
                        </p>
                    </div>
                    <div class="input-field col s12 <?php if ($user_bg_type != 2) {
                            echo 'plz-hide';
                        } ?>">
            ...
            <div class="card">
                ...
                <div class="card-action row">
                    <div class="input-field col s12" style="margin-bottom: 15px;">
                        <p>Music Type</p>
                        <p>
                            <input type="radio" id="music_type_default" class="with-gap" name="music_type" onclick="checkMusicType()" value="0" <?php if ($user_music_type == 0) {
            echo 'checked="checked"';
        } ?> />
                            <label for="music_type_default">Default</label>
                        </p>
                        <p>
                            <input type="radio" id="music_type_yt" class="with-gap" name="music_type" onclick="checkMusicType()" value="1" <?php if ($user_music_type == 1) {
            echo 'checked="checked"';
        } ?> />
