...
if (!empty($background['video'])) { $json_output->background_video = $background['video']; }
if (!empty($background['yt'])) { $json_output->background_yt = $background['yt']; }
$json_output->background_random = $background['random'];
$json_output->background_duration = $background['duration'] * 1000;
if (!empty($youtube['playlist'])) { $json_output->youtube_playlist = $youtube['playlist']; }
